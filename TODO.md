...
- [x] `T26` Run the eight manual acceptance scenarios from the HLD verification list — manual, depends-on: T3, T5, T7, T25, design: docs/designs/2026-09-10-sideye-code-review-mvp.md
